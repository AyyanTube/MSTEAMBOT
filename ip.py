...
def find_between( data, first, last ):
    try:
        ...
        return None
url = "https://scamalytics.com/ip/45.115.105.132"


m = requests.get(url).text

ip = find_between(m, '"ip":"','",')
score = find_between(m, '"score":"','",')
risk = find_between(m, '"risk":"','"')
countery = find_between(m, '<title>','</title>')
cc = find_between(m, '<th>Country Name</th>','</td>')
